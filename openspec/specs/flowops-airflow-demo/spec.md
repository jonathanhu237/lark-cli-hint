...
## Purpose
`flowops-airflow-demo` covers the reproducible local FlowOps demo environment, the Feishu seed script for internal mock knowledge, and the opt-in gates for real LLM/Feishu/Airflow E2E validation.
